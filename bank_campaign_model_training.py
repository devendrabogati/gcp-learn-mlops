...
bucket = storage_client.bucket("learn_gcp_04")
...
def write_metrics_to_bigquery(algo_name, training_time, model_metrics):
    ...
    table_id = "learngcp-487007.ml_ops.bank_campaign_model_metrics"
...
def main():
    input_data_path = "gs://learn_gcp_04/bank-additional.csv"
    model_name='xgboost'
